...
- Generated: 2026-07-16 15:04:44 +08:00
...
- Verified-check completion: **90.3%**
...
| Git | Tracked working tree | No tracked source changes. Untracked entries: 7. |
...
|---:|---|---|---|---|---|
| 1 | Runtime | API port 3000 | FAILED | localhost:3000 is not accepting connections. | Start the NestJS backend. |
| 2 | Database Models | Maintenance | MISSING | Model not found. | Add the model if required by project scope. |
| 3 | Android Integration | Backend API references | PARTIAL | 5 network/API reference(s) found. | Runtime verification is still required. |
| 4 | Documentation | README documentation | PARTIAL | C:\Users\YASSER\Desktop\CPEB_UNIFIED_PROJECT\CODES\README.md; C:\Users\YASSER\Desktop\CPEB_UNIFIED_PROJECT\CODES\apps\api\README.md | Review documentation completeness and accuracy. |
| 5 | Testing | Android test files | PARTIAL | 2 Android test file(s) found. | Passing tests must still be verified. |
| 6 | Testing | Backend test files | PARTIAL | 3 test-related file(s) found. | Passing tests must still be verified. |
...
| Git | Tracked working tree | COMPLETE | No tracked source changes. Untracked entries: 7. |  |
| Git | Untracked files | INFO | ?? CPEB_ADMIN_AND_OPERATIONS.ps1; ?? CPEB_ADMIN_FINAL_REPAIR.ps1; ?? CPEB_ENGINEERING_REPAIR_AND_VALIDATE.ps1; ?? CPEB_PROJECT_AUDIT.ps1; ?? backups/ADMIN_FINAL_REPAIR_20260716_012349/; ?? backups/ADMIN_FINAL_REPAIR_20260716_013042/; ?? backups/ADMIN_OPERATIONS_20260716_000021/ |  |
...
| Runtime | API port 3000 | FAILED | localhost:3000 is not accepting connections. | Start the NestJS backend. |
