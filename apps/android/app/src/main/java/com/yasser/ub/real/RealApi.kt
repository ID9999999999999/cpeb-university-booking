...
object ApiFactory{const val BASE_URL="http://10.190.66.192:3000/";val api:RealApi by lazy{Retrofit.Builder().baseUrl(BASE_URL).addConverterFactory(GsonConverterFactory.create()).build().create(RealApi::class.java)}}