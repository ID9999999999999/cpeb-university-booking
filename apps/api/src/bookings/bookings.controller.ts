...
import { BookingAvailabilityQueryDto, CreateBookingDto } from './bookings.dto';
...
export class BookingsController {
  ...
  @Get('availability') availability(@Query() query: BookingAvailabilityQueryDto) { return this.s.availability(query); }
  @Post() create(@Request() r: any, @Body() b: CreateBookingDto) {
    return this.s.create({ equipmentId: b.equipmentId, userId: this.uid(r), startTime: b.startTime, endTime: b.endTime, reason: b.reason });
  }
